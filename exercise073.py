...
# a) Os 5 primeiros times. b) Os últimos 4 colocados. c) Times em ordem alfabética. d) Em que posição está o time do Goiás.
...
print(f'Os times em ordem alfabética: {sorted(teams)}')
print(f'O Goiás ficou em {teams.index("Goiás")+1}º lugar')
