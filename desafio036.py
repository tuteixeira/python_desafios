...
salario = float(input('{} seu salário atual é: R$ ' .format(nome)))
tempo = int(input('Em quantos anos pretende pagar? '))
parcela = valor / (tempo * 12)
if parcela >= salario * 30 / 100:
    print('{} a parcela de {:.2f} é superior a 30% do salário\n\033[1;31mO EMPRÉSTMO FOI NEGADO.\033[m' .format(nome, parcela))
else:
    print('{} a parcela de {:.2f} é acima do permitido para o seu salário\n\033[1;31mSEU EMPRÉSTIMO FOI ACEITO\033[m'.format(nome,parcela))